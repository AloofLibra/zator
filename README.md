Проект рождён как форк [zapret4rocket](https://github.com/IndeecFOX/zapret4rocket) и является его идейным продолжением и развитием. 
Ключевым отличием является переход на zapret2. 
Вся история коммитов до разделения сохранена.

### Что делает проект
Устанавливает последнюю версию zapret2 с актуальными рабочими стратегиями обхода блокировок. Вам всего-лишь требуется жать Enter.
Скрипт поддерживает быстрый подбор стратегий из проверенных и добавленных в него.
YouTube без ограничений и рекламы, работа войсов Discord, доступ к ntc.party, meduza.io и прочим ресурсам
